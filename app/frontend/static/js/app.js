// Grassroot Finishline Dashboard – static (non-Vite) build
...
// ── Live Preview (first-frame canvas render) ───────────────────────
...
// ── Thumbnail logger (backend-driven crossing strip) ───────────────
...
function buildThumbLog(arrivals) {
    ...
    // Only rebuild when content has actually changed
